  ...
  <q-layout view="hHh Lpr lff" container style="height: 100vh" class="shadow-2 rounded-borders">
    <!-- <q-header elevated class="row no-wrap shadow-1 bg-black">
      <q-toolbar class="col-6">
        ...
        <q-toolbar-title>Suka_Dev</q-toolbar-title>
      </q-toolbar>

      <q-toolbar class="col-6 bg-positive text-white">
        <q-space />
          ...
          <q-list>
            ...
            >
              <q-item-section avatar>
                <q-avatar icon="library_music" color="positive" text-color="white" />
              </q-item-section>
              <q-item-section>
      ...
      <q-scroll-area class="fit">
        <q-list padding>
          ...
          <q-item clickable v-ripple to="/about">
            ...
            <q-item-section>PRESENTATION</q-item-section>
          </q-item>
          <q-separator></q-separator>
          ...
          <q-item clickable v-ripple to="/social">
            ...
            <q-item-section>RESEAUX</q-item-section>
          </q-item>
          ...
          <q-item clickable v-ripple to="/skill">
            ...
            <q-item-section>COMPETENCES</q-item-section>
          </q-item>
          ...
          <q-item clickable v-ripple to="/project">
            <q-item-section avatar>
              <q-icon name="extension" color="white"/>
            </q-item-section>
